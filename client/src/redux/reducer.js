import { GET_POKEMONS, BACK_PAGE, NEXT_PAGE, ORDER_POKEMONS, FILTER_POKEMONS, BY_BASE_LOCAL, GET_POKEMON_id, GET_POKEMON_NAME, POST_POKEMON, DELETE_POKEMON, GET_TYPES } from "./actionsType";
const initialState = {
    aPokemon: [],
    pokemons: [],
    pokemonsFyO: [],
